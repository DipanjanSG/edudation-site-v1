          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={link.path}>
                  <Link to={link.path} className="text-green-100 hover:text-white transition-colors flex items-center group">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={service.path}>
                  <Link to={service.path} className="text-green-100 hover:text-white transition-colors flex items-center group">
                    <ArrowRight className="w-4 h-4 mr-2 transform group-hover:translate-x-1 transition-transform" />
                    {service.label}
                  </Link>
                </li>
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={index} className="flex items-start">
                  <item.Icon className="w-5 h-5 text-green-300 mr-3 mt-0.5" />
                  <p
        ...
        <div className="mt-12 pt-8 border-t border-green-800">
          <div className="flex flex-col md:flex-row md:justify-between items-center">
            ...
            <div className="flex space-x-6">
              ...
              <Link to="/cookies" className="text-green-200 hover:text-white transition-colors">Cookie Policy</Link>
            </div>
          </div>
        </div>
      </div>
