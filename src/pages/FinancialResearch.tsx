  ...
  return (
    ...
    >
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 md:order-2">
              <h2 className="text-3xl font-bold mb-6 text-green-900">Our Research Approach</h2>
      ...
      <section className="py-20 bg-green-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-green-900">Our Research Services</h2>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-green-900">Our Research Process</h2>
            <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-green-50 p-8 rounded-lg shadow-lg">
              <h3 className="text-xl font-semibold mb-4 text-green-900">Data Collection & Analysis</h3>
            ...
            <div className="bg-green-50 p-8 rounded-lg shadow-lg">
              <h3 className="text-xl font-semibold mb-4 text-green-900">Insights & Recommendations</h3>
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start">
                  <span className="text-green-600 font-bold mr-2">1.</span>
      ...
      <section className="py-20 bg-green-900 text-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-green-200 mt-4">Our research services cater to a diverse range of financial stakeholders</p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-green-900 mb-6">Ready to Make Data-Driven Financial Decisions?</h2>
